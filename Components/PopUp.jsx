        ...
        <>
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                    {/*content*/}
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-600 bg-white outline-none focus:outline-none">
                        {/*header*/}
                        ...
                        {/*body*/}
                        <div className="relative p-6 flex-auto" style={{ maxHeight: "500px", width: "600px" }}>
                            <p className="my4 text-slate-500 text-lg leading-relaxed">
                                {donate.description}
                            </p>
                            <input
